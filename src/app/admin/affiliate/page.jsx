  ...
  return (
    <div>
         <div className="flex justify-between items-center mb-4">
            ...
            <div>
            <Button variant="outline" className="bg-blue-300 rounded-lg"><Plus/> Invite Affiliate</Button>
        ...
        <Table className="border rounded-lg w-full">
          ...
          <TableBody className="w-full">
            {invoices.map((invoice) => (
              <TableRow key={invoice.affiliate} onClick={() => router.push(`/admin/affiliate/${invoice?.affiliate}`)} className="cursor-pointer">
